...
var DEPENDENCIES_REG = /(^(eslint|stylelint|@babel\/eslint-parser|markdownlint|@commitlint\/cli)$|^(eslint|vue-eslint|stylelint|markdownlint|commitlint)-\S+$|^@typescript-eslint\/\S+$)/;
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                willRemovePackage = dependencies.filter(function (name) { return DEPENDENCIES_REG.test(name); });
