...
var markdownlint_config_ali_1 = __importDefault(require("markdownlint-config-ali"));
...
var lint = function (options) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    if (options.fix) {
                        for (var file in result) {
                            if (!Object.prototype.hasOwnProperty.call(result, file))
                                continue;
                            var fixes = result[file].filter(function (error) { return error.fixInfo; });
                            if (fixes.length > 0) {
                                var originalText = fs_extra_1.default.readFileSync(file, 'utf8');
                                var fixedText = markdownlint_rule_helpers_1.default.applyFixes(originalText, fixes);
                                if (originalText !== fixedText) {
                                    fs_extra_1.default.writeFileSync(file, fixedText, 'utf8');
                                    result[file] = result[file].filter(function (error) { return !error.fixInfo; });
                                }
                            }
                        }
                    }
